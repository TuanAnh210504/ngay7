...
module.exports = {
    ...
    ChangePasswordValidator: [
        body('oldpassword').notEmpty().withMessage("oldpassword khong duoc rong").bail().isString().withMessage("oldpassword phai la xau"),
        body('newpassword').notEmpty().withMessage("newpassword khong duoc rong").bail().isStrongPassword({
            ...
            minSymbols: 1,
            minUppercase: 1
        }).withMessage("newpassword it nhat 8 ki tu trong do co it nhat 1 ki tu dac biet, 1 ki tu in hoa, 1 ki tu thuong , 1 ki tu so")
    ]
}